...
$query = 'SELECT * FROM projekt.uzytkownicy';
$result = pg_query($query) or die('Nie udalo sie odczytac polecenia ' . pg_last_error());

echo "<center><p>Użytkownicy</p>";
echo "<table>\n";
echo "<tr><td>ID_UZYTKOWNIK</td><td>Imie</td><td>Nazwisko</td><td>e-mail</td><td>Data urodzenia</td><td>Miasto zamieszkania</td><td>Ulica</td><td>Nr domu</td><td>Kod pocztowy</td></tr>";
